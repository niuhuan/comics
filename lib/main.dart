...
/// 代理设置组件
class _ProxySettingsTile extends StatefulWidget {
  const _ProxySettingsTile();

  @override
  State<_ProxySettingsTile> createState() => _ProxySettingsTileState();
}

class _ProxySettingsTileState extends State<_ProxySettingsTile> {
  String? _proxyUrl;
  bool _loading = false;
